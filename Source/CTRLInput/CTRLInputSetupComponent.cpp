...
void UCTRLInputSetupComponent::SetupInputComponent(UInputComponent* PlayerInputComponent)
{
	// Add Input Mapping Context
	if (auto const Pawn = GetOwner<APawn>())
	{
		if (auto const* PlayerController = Cast<APlayerController>(Pawn->GetController()))
		{
